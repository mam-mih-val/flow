...
// Thu Sep 27 22:26:45 2018 by ROOT version 6.14/04
// from TTree cbmsim_reduced/cbmsim_reduced
// found on file: merged_0.root
//////////////////////////////////////////////////////////
...
Int_t merged::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t merged::LoadTree(Long64_t entry)
{
...
void merged::Show(Long64_t entry)
{
...
Int_t merged::Cut(Long64_t entry)
{
